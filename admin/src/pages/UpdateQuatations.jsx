...
export default function UpdateQuatations() {
  ...
  const handleSubmit = async (e) => {
    ...
    try
    {
      ...
      const res = await axios.put(url + `/api/quatation/update-quatation/${quatationId}`,formData,{headers:{token}})
      ...
      if(res.data.success)
      {
        ...
        toast.success(`quatation ${res.data.updatedQuatation.number} is updated successfully`)
  ...
  const fetchQuatation = async () => {
    ...
    try
    {
        ...
        const res = await axios.get(url + `/api/quatation/get-quatation/${quatationId}`)

        if(res.data.success)
        {
          setFormData(res.data.quatation)
  ...
  return (
    ...
    <>
      ...
      {!quatationError && !quatationLoading && (
