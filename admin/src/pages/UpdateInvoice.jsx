...
export default function UpdateInvoice() {
  ...
  const handleSubmit = async (e) => {
    ...
    try
    {
      ...
      const res = await axios.put(url + `/api/invoice/update-invoice/${invoiceId}`,formData,{headers:{token}})
  ...
  const fetchInvoice = async () => {
    ...
    try
    {
        ...
        const res = await axios.get(url + `/api/invoice/get-invoice/${invoiceId}`)
    ...
    <>
        ...
        {!invoiceLoading && !invoiceError && (
          ...
          <div className="section space-y-7">
            ...
            <h2 className="title2 text-primary text-center">Update Invoice</h2>
